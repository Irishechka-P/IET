...
# тестирование ЛЕВОГО шага индукции с origin.first<image.first
"""
T = IET()
T.set_via_permutation([0, 4, 2, 1, 3], [0, 1, 4, 3, 5])
...
# тестирование ПРАВОГО шага индукции с origin.last>image.last
"""
T = IET()
T.set_via_permutation([0, 3, 5, 1, 4, 2], [0, 2.5, 3.0, 2.0, 2.5, 5.0])
