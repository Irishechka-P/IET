...
# two triplets, one with cycle length 69, another with cycle length 56
"""
...
"""
# (a+b+c, b, c)
lengths_before = [[0, 0, 0], [1, 3, 0], [1, 1, 0], [-2, -3, 1], [-2, -5, 1], [1, 1, 0], [1, 1, 0], [0, 2, 0]]
T.set_via_permutation([0, 4, 7, 2, 6, 1, 3, 5], lengths_before)
# two triplets, both with cycle length 63 
"""


# (a, b, c)
lengths_before = [[0, 0, 0], [2, 7, -1], [-2, -5, 1], [-2, -5, 1], [1, 1, 0], [3, 6, -1], [-2, -5, 1], [0, 2, 0]]
T.set_via_permutation([0, 3, 6, 5, 1, 7, 2, 4], lengths_before)
# two triplets, both with cycle length 63, the same as in the (a+b+c,b,c)-case
