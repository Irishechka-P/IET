...
def get_the_structure_of_cycle(T, kit):
    ...
    while not t:
        ...
        for i in range(1, length // 2 + 1):
            if (kit['list of permutations'][length - i: length] == kit['list of permutations'][length - 2 * i: length - i]) and (check_proportion(kit['list of lists of lengths'][length - i].copy(), kit['list of lists of lengths'][length - 2*i].copy(), [1, 1, 1])):
